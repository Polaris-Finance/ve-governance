...
//     Clock,
//     Lock,
//     Curve as LinearDecreasingCurve,
//     ExitQueue,
//     GaugeVoter,
//     GaugeVoterSetup,
...
//         curve = LinearDecreasingCurve(pluginSet.curve);
...
//         escrow.createLock(100 ether, MAX_TIME);
//
//         vm.expectRevert("Pausable: paused");
//         escrow.createLockFor(100 ether, MAX_TIME, address(this));
//
//         vm.expectRevert("Pausable: paused");
//         escrow.withdraw(0);
//
...
//
//                 escrow.createLock(depositAlice0, MAX_TIME);
//
//                 goToEpochStartPlus(8 days);
//
//                 escrow.createLockFor(depositAliceBob, MAX_TIME, bob);
//             }
//             vm.stopPrank();
//         }
//
...
//             vm.startPrank(alice);
//             {
//                 escrow.createLock(depositAlice1, MAX_TIME);
//             }
//             vm.stopPrank();
//
//             // check the token points written
...
//                 escrow.createLockFor(balanceCarol, MAX_TIME, address(badMultisig));
//
//                 // he fixes it
//                 carolsMultisig = new MultisigReceiver();
//
//                 escrow.createLockFor(balanceCarol, MAX_TIME, address(carolsMultisig));
//
